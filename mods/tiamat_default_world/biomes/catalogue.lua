...
biome{ id = "mossy_limestone", name = "Mossy Limestone", area = "normal_caves",
    note = "2.1 (2026-09-18) — vaulted domes joined by crawlspaces; mud floors, rimstone basins with still water, moss over the lower surfaces, vines from the ceiling, maidenhair at the drips. The caves' province noise between 0 and 0.15 (-0.12 to 0.14 at first). Crystal veins through its rock. Variant 2.1.1 Dewdrop Grotto (2026-09-23): beaded glowing succulent vines off the ceiling, pale cave orchids in the wall pockets, spore pads and lit waterlilies on the pools." }
biome{ id = "crystal_seam", name = "Crystal Seam", area = "normal_caves",
    note = "2.2 (2026-09-18) — narrow fault corridors with V-shaped ceilings; slate over basalt laced with crystal veins that run on through every cave's rock; a few clusters, spires, geodes, shards. Province under -0.33 (-0.12 at first). Variant 2.2.1 Fractured Amethyst Seam (2026-09-23): hollow geode pockets in the shale for the spires, glittering crystal gravel in the scree, needle-thin chandeliers off the clefts." }
biome{ id = "underground_river", name = "Underground River", area = "normal_caves",
    note = "2.3 (2026-09-18) — meandering tubes with an undercut bank and a sloping shelf; a flowing channel two deep over cobbles and gravel, silt on the banks, glowing algae at the waterline, moss pads in the current, roots from the ceiling, snags. Province over 0.33 (0.14 at first). Variant 2.3.1 Petrified Driftwood Rapids (2026-09-23): rock teeth in the channel, petrified trunks lodged bank to bank, calcified root-cages holding river glass and bone." }
biome{ id = "fungal_grove_chambers", name = "Fungal Grove Chambers", area = "normal_caves",
    note = "2.4 (2026-09-18) — bulbous chambers with tiered walls and alcoves; loam and peat under mycelium mats; parasol mushrooms, wall brackets, glowing puffballs that burst when brushed, cap-clusters, hollow dead stalks, compost heaps, spore haze. Province 0.15 to 0.33. Variant 2.4.1 Ghost-Cap Thicket (2026-09-23): weeping-bell mushrooms with milky lit hoods for the parasols, a luminous mycelium lattice over the loam, glowing sap strands off the brackets." }
biome{ id = "mineral_vein_tunnels", name = "Mineral Vein Tunnels", area = "normal_caves",
    note = "2.5 (2026-09-18) — box-section corridors on fracture lines, three levels; strata of granite, banded ironstone and slate with copper and galena ribbons; frostings, pyrite and galena cubes, rust, ore knuckles, slab-collapses, quartz. Province -0.33 to -0.15. Variant 2.5.1 Oxidized Copper Chasm (2026-09-23): branching copper dendrites out of the walls for the ore nodes, verdigris and rust weathering, sulfur vents along the floors." }
biome{ id = "stalactite_forests", name = "Stalactite Forests", area = "normal_caves",
    note = "2.6 (2026-09-18) — tall flowstone halls crowded with stalactites, stalagmites, columns and draperies; calcite pavement with rimstone pools; soda straws, debris, drips. Province -0.15 to 0. Variant 2.6.1 Weeping Drapery Chamber (2026-09-23): thin wavy flowstone draperies for the columns, soda straws dominant, terraced rimstone pools with cave pearls." }
