...
local function structures()
    ...
    if not game.schematic_shapes then
        game.log("tiamat_default_world rainforest: no game.schematic_shapes in this engine; no trees")
        BUILT = out
        return out
    end
    ...
    game.log("tiamat_default_world rainforest: cut " .. table.concat(counts, ", "))
    BUILT = out
    return out
end
...
local IVY = "tiamat_default_world:climbing_ivy"
