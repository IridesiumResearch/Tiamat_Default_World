...
local function structures()
    ...
    if not game.schematic_shapes then
        game.log("tiamat_default_world deep ocean: no game.schematic_shapes in this engine; no structures")
        BUILT = out
        return out
    end
    ...
    game.log("tiamat_default_world deep ocean: cut " .. table.concat(parts, ", "))
    BUILT = out
    return out
end
